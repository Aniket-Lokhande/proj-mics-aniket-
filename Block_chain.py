...
blockchain.newblock("Hi, This block was created by Aniket")
blockchain.newblock("Hi, This block was created by aashish")
blockchain.newblock("Hi, This block was created by prathamesh")
